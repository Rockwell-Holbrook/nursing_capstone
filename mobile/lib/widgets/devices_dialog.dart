...
class FindDevicesScreen extends StatelessWidget {
  ...
  List<Widget> presentDevices(List<Widget> listWithBlanks) {
        ...
        child: Column(
          children: <Widget>[
            ...
            StreamBuilder<List<ScanResult>>(
              ...
              initialData: [],
              builder: (c, snapshot) => Column(
                children: presentDevices(snapshot.data
                  .map(
                    (r) => ScanResultTile(
                      result: r,
...
//               initialData: [],
//               builder: (c, snapshot) => Column(
//                 children: presentDevices(
//                   snapshot.data
//                     .map(
//                       (r) => Text(r.device.name.toString()
//                     )
//                   ).toList(),
//                 )
//               ),
...
//     List<Widget> listNoBlanks = [];
//     for(int i = 0; i < listWithBlanks.length; i++) {
//       Text text = listWithBlanks[i];
//       if(text.data != "") {
//         listNoBlanks.add(listWithBlanks[i]);
//       }
//     }
//     return listNoBlanks;
//   }
