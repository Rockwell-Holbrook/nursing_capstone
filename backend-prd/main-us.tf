...
resource "aws_api_gateway_domain_name" "api_domain" {
  domain_name              = "api.byu-dept-nursingsteth-prd.amazon.byu.edu"
  regional_certificate_arn = "arn:aws:acm:us-west-2:847766923153:certificate/310295e6-0f2c-4341-a488-607bd215d69a"
